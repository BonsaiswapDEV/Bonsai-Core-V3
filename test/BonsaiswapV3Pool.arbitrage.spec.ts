...
import { BonsaiswapV3PoolSwapTest } from '../typechain/BonsaiswapV3PoolSwapTest'
...
describe('BonsaiswapV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('BonsaiswapV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as BonsaiswapV3PoolSwapTest
          ...
          let tester: BonsaiswapV3PoolSwapTest
