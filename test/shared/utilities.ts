...
export function createPoolFunctions({
  ...
  swapTarget: TestBonsaiswapV3Callee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeBonsaiswapV3Pool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestBonsaiswapV3Router
  poolInput: MockTimeBonsaiswapV3Pool
  poolOutput: MockTimeBonsaiswapV3Pool
}): MultiPoolFunctions {
