...
describe('BonsaiswapV3Pool', () => {
  ...
  let pool0: MockTimeBonsaiswapV3Pool
  let pool1: MockTimeBonsaiswapV3Pool
  ...
  let swapTargetCallee: TestBonsaiswapV3Callee
  let swapTargetRouter: TestBonsaiswapV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeBonsaiswapV3Pool, any]> => {
